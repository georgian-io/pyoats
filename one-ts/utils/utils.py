...
def graph_data(series: npt.NDArray[Any], labels: npt.NDArray[Any], train_len: int):

    # create fig and axes
    fig, (ax, ax2) = plt.subplots(
        nrows=2, sharex=True, gridspec_kw={"hspace": HSPACE, "height_ratios": HRATIO}
    )
    ...
    ax.annotate(
        "Training Data Ends", (train_len * 1.01, ax.get_ylim()[1]), fontsize="x-large"
    )
